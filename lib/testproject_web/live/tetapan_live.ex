defmodule TestprojectWeb.TetapanLive do
    ...
    <div class="w-full min-h-screen bg-gray-100 flex">
      ...
      <div class="w-64 bg-blue-900 text-white">
        ...
        <nav class="p-4">
          ...
          <.link navigate={~p"/admin/kursus"} class="block p-3 mb-2 rounded-lg hover:bg-gray-700">
            Kursus
          </.link>
          ...
          <.link navigate={~p"/admin/peserta"} class="block p-3 mb-2 rounded-lg hover:bg-gray-700">
            Peserta
          </.link>

          <.link navigate={~p"/admin/elaunpekerja"} class="block p-3 mb-2 rounded-lg hover:bg-gray-700">
            Elaun Peserta
          </.link>
